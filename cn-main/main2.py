...
def run_aria2c_download():
 ...
 if params["ui"]=="V1.6SDXL":
  subprocess.run(f'aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/lllyasviel/sd_control_collection/resolve/main/sai_xl_canny_256lora.safetensors -d {params["dir"]}/models/ControlNet -o sai_xl_canny_256lora.safetensors',shell=True)
  subprocess.run(f'aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/lllyasviel/sd_control_collection/resolve/main/sai_xl_depth_256lora.safetensors -d {params["dir"]}/models/ControlNet -o sai_xl_depth_256lora.safetensors',shell=True)
  subprocess.run(f'aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/lllyasviel/sd_control_collection/resolve/main/kohya_controllllite_xl_openpose_anime_v2.safetensors -d {params["dir"]}/models/ControlNet -o kohya_controllllite_xl_openpose_anime_v2.safetensors',shell=True)
  subprocess.run(f'aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/lllyasviel/sd_control_collection/resolve/main/sargezt_xl_softedge.safetensors -d {params["dir"]}/models/ControlNet -o sargezt_xl_softedge.safetensors',shell=True)
  subprocess.run(f'aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/lllyasviel/sd_control_collection/resolve/main/t2i-adapter_diffusers_xl_lineart.safetensors -d {params["dir"]}/models/ControlNet -o t2i-adapter_diffusers_xl_lineart.safetensors',shell=True)
  subprocess.run(f'aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/lllyasviel/sd_control_collection/resolve/main/thibaud_xl_openpose.safetensors -d {params["dir"]}/models/ControlNet -o thibaud_xl_openpose.safetensors',shell=True)
 else:
 ...
 if params["animatediff"]=="True":
  subprocess.run(f'aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/guoyww/animatediff/resolve/main/mm_sd_v15_v2.ckpt -d {params["dir"]}/extensions/sd-webui-animatediff/model -o mm_sd_v15_v2.ckpt',shell=True)
 end_time=time.time()
